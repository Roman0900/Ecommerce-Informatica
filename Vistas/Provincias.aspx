<%@ Page Title="Provincias" Language="C#" MasterPageFile="~/MaterPage/BaseProg3.Master" AutoEventWireup="true" CodeBehind="Provincias.aspx.cs" Inherits="Vistas.Provincias" %>
         ...
         <table>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <span class="auto-style2">Ingrese Provincia:</span>&nbsp;&nbsp;
                    <asp:TextBox ID="txtFiltroPro" runat="server" Width="260px"></asp:TextBox>
                    <strong>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <br />
                    <asp:GridView ID="gvProvincia" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="200px" Width="900px" PageSize="5" AutoGenerateColumns="False" AutoGenerateEditButton="True" OnRowCancelingEdit="gvProvincia_RowCancelingEdit" OnRowEditing="gvProvincia_RowEditing" OnRowUpdating="gvProvincia_RowUpdating" AllowPaging="True" OnPageIndexChanging="gvProvincia_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Eliminar">
                                <ItemTemplate>
                                    <asp:ImageButton ID="eliminar" runat="server" CommandArgument='<%# Eval("Codigo") %>' CommandName="EliminarClick" ControlStyle-Width="25px" ImageUrl="~/Imagenes/tachito.jpg" OnClientClick="javascript:return confirm('Esta seguro que quiere eliminar esta Provincia?');" OnCommand="eliminar_Command" Width="25px" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
